 ...
 * Though not mandatory, you are requested to attribute NRFA URL in your code or website.
 * 
 * NRFA ==> NNPC Retails Fuel App
 */

namespace NRFA\SecurityService;
...
class securityService
{
    ...
    private $formTokenLabel = 'nrfa-csrf-token-label';

    private $sessionTokenLabel = 'NRFA_CSRF_TOKEN_SESS_IDX';
