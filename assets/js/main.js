...
function upload_excel_content(form_id, url) {
  ...
  $.blockUI({
    message:
      '<img src="loading.gif" alt=""/>&nbsp;&nbsp;processing request please wait . . .',
  });
  formurl = url + ".php";
...
function callpost(page) {
  ...
  //$("#display_message").ajaxStart(function(){
  //$.blockUI({ message:'<img src="loading.gif" alt=""/><br />processing request please wait . . .'});
  //});
  $.ajax({
    type: "POST",
    url: "utilities.php",
...
function callpagepost(str, divid) {
  ...
  if (data != "error") {
    ...
    $.blockUI({
      message:
        '<img src="loading.gif" alt=""/><br />processing request please wait . . .',
    });
    //});
    ...
    /*
			...
			$(divid).html('');
			$(divid).html('<img src="loading.gif" alt="" />loading please wait . . .');
			});
			*/
    if (str != "#") {
      //trapSession();
      ...
      //$("#display_message").html('<img src="loading.gif" alt="" />loading please wait . . .');
...
function callGenMOPTPG(mid) {
  ...
  if (mid != "") {
    //	$.blockUI({ message:'<img src="loading.gif" alt=""/>&nbsp;&nbsp;loading please wait . . .'});
    //$("#display_message").html('<img src="loading.gif" alt="" />loading please wait . . .');
    $.ajax({
      type: "POST",
      url: "utilities.php",
...
function getstate(country) {
  $("#state_div").html(
    '<img src="loading.gif" alt=""/>&nbsp;&nbsp;Loading states please wait . . .'
  );
...
function importExcel() {
  ...
  $.blockUI({
    message:
      '<img src="loading.gif" alt=""/><br />Extracting File to Database . . .',
  });
  $.ajax({
    type: "POST",
    url: "utilities.php",
